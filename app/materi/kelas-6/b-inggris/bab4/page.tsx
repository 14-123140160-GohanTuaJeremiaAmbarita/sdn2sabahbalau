...
const quizQuestions = [
  {
    question: "1. 'Yesterday' (kemarin) adalah penanda waktu untuk...",
    options: ["Sekarang (Present)", "Akan Datang (Future)", "Lampau (Past)"],
    correctAnswer: "Lampau (Past)"
  },
  {
    question: "2. The opposite of 'Happy' (senang) is...",
    options: ["Tired (lelah)", "Sad (sedih)", "Angry (marah)"],
    correctAnswer: "Sad (sedih)"
  },
  {
    question: "3. Kata ganti (subject) yang menggunakan 'was' adalah...",
    options: ["We, You, They", "She, He, It", "We, I, They"],
    correctAnswer: "She, He, It"
  },
  {
    question: "4. Kata ganti (subject) yang menggunakan 'were' adalah...",
    options: ["I, He, She", "You, We, They", "It, He, She"],
    correctAnswer: "You, We, They"
  },
  {
    question: "5. 'He ... busy yesterday.'",
    options: ["were", "was", "is"],
    correctAnswer: "was"
  },
  {
    question: "6. 'We ... at the beach last summer.'",
    options: ["was", "were", "are"],
    correctAnswer: "were"
  },
  {
    question: "7. The simple past form of 'is' or 'am' is...",
    options: ["are", "were", "was"],
    correctAnswer: "was"
  },
  {
    question: "8. The past form of 'They are strong' is...",
    options: ["They was strong", "They were strong", "They strong"],
    correctAnswer: "They were strong"
  },
  {
    question: "9. If someone feels 'tired', they are...",
    options: ["Lelah", "Senang", "Marah"],
    correctAnswer: "Lelah"
  },
  {
    question: "10. Where ... you last night?",
    options: ["is", "was", "were"],
    correctAnswer: "were"
  }
];

const localStorageKey_Answers = 'quiz_bing_6_4_answers';
const localStorageKey_Score = 'quiz_bing_6_4_score';

export default function MateriBing6Bab4Page() {
