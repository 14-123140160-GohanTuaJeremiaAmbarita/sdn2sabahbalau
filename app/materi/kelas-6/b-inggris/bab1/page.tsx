...
const quizQuestions = [
  {
    question: "1. 'I ___ hamburger yesterday.' (Bentuk lampau dari 'eat')",
    options: ["eat", "eaten", "ate"],
    correctAnswer: "ate"
  },
  {
    question: "2. 'Yesterday' (kemarin) adalah penanda waktu untuk...",
    options: ["Simple Present Tense (Sekarang)", "Simple Past Tense (Lampau)", "Simple Future Tense (Akan Datang)"],
    correctAnswer: "Simple Past Tense (Lampau)"
  },
  {
    question: "3. 'She ___ to the zoo last week.' (Bentuk lampau dari 'go')",
    options: ["go", "gone", "went"],
    correctAnswer: "went"
  },
  {
    question: "4. Bentuk lampau (Past Tense) dari 'drink' (minum) adalah...",
    options: ["drank", "drinked", "drunk"],
    correctAnswer: "drank"
  },
  {
    question: "5. Bentuk lampau (Past Tense) dari 'study' (belajar) adalah...",
    options: ["studyed", "studied", "stady"],
    correctAnswer: "studied"
  },
  {
    question: "6. 'They ... football last night.' (Bentuk lampau dari 'play')",
    options: ["played", "play", "playing"],
    correctAnswer: "played"
  },
  {
    question: "7. Kalimat negatif: 'I ... not eat hamburger yesterday.'",
    options: ["do", "am", "did"],
    correctAnswer: "did"
  },
  {
    question: "8. Kalimat tanya: '... you eat hamburger yesterday?'",
    options: ["Did", "Do", "Are"],
    correctAnswer: "Did"
  },
  {
    question: "9. Bentuk lampau (Past Tense) dari 'see' (melihat) adalah...",
    options: ["seed", "saw", "seen"],
    correctAnswer: "saw"
  },
  {
    question: "10. 'He ___ sad yesterday.' (Bentuk lampau dari 'is')",
    options: ["is", "was", "were"],
    correctAnswer: "was"
  }
];

const localStorageKey_Answers = 'quiz_bing_6_1_answers';
const localStorageKey_Score = 'quiz_bing_6_1_score';

export default function MateriBing6Bab1Page() {
