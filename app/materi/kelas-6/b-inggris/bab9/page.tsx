...
const quizQuestions = [
  {
    question: "1. 'Next month' is a time marker for the ...",
  ...
  {
    question: "3. After 'will', the main verb must be in the ... form.",
    options: ["Past form", "Base form", "Continuous form"],
    correctAnswer: "Base form",
  },
  {
    question: "4. I ... go to Bali next month.",
    options: ["go", "will", "went"],
    correctAnswer: "will",
  },
  {
    question: "5. They will ... souvenirs from Bali.",
    options: ["buy", "bought", "buying"],
    correctAnswer: "buy",
  },
  {
    question: "6. The negative form of 'She will travel' is:",
    options: ["She won't travel.", "She will not travels.", "She don't travel."],
    correctAnswer: "She won't travel.",
  },
  {
    question: "7. The question form of 'You will visit Bali' is:",
    options: [
      "Did you visit Bali?",
      "Will you visit Bali?",
      "Are you visiting Bali?",
    ],
    correctAnswer: "Will you visit Bali?",
  },
  {
    question: "8. 'We ... pack our bags soon.'",
    options: ["packed", "will pack", "packs"],
    correctAnswer: "will pack",
  },
  {
    question: "9. 'Soon' is a time marker for the ...",
    options: ["Past", "Future", "Now"],
    correctAnswer: "Future",
  },
  {
    question: "10. The contraction for 'We will' is...",
    options: ["We'd", "We'll", "We'am"],
    correctAnswer: "We'll",
  },
];

const localStorageKey_Answers = "quiz_bing_6_9_bali_answers";
const localStorageKey_Score = "quiz_bing_6_9_bali_score";

export default function MateriBing6BaliPage() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 9 - Bali"
                  frameBorder="0"
