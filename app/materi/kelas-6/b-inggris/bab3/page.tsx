...
const quizQuestions = [
  {
    question: "1. 'I was happy.' Which subject pronoun uses 'was'?",
    options: ["We", "They", "I"],
    correctAnswer: "I"
  },
  {
    question: "2. 'You were tired.' Which subject pronoun uses 'were'?",
    options: ["She", "He", "You"],
    correctAnswer: "You"
  },
  {
    question: "3. The simple past form of 'is' (to be) is...",
    options: ["Are", "Was", "Been"],
    correctAnswer: "Was"
  },
  {
    question: "4. They ... at the cinema last night.",
    options: ["was", "were", "is"],
    correctAnswer: "were"
  },
  {
    question: "5. He ... in Jakarta two days ago.",
    options: ["were", "was", "are"],
    correctAnswer: "was"
  },
  {
    question: "6. 'Last Week' is a time marker for the ...",
    options: ["Present", "Future", "Past"],
    correctAnswer: "Past"
  },
  {
    question: "7. Question form: '... you at home yesterday?'",
    options: ["Was", "Is", "Were"],
    correctAnswer: "Were"
  },
  {
    question: "8. Complete: 'We were in Lombok, but she ... not there.'",
    options: ["were", "was", "is"],
    correctAnswer: "was"
  },
  {
    question: "9. 'I was sad.' Kata kerja 'was' di sini adalah bentuk lampau dari...",
    options: ["am", "do", "will"],
    correctAnswer: "am"
  },
  {
    question: "10. Where ... they last Sunday?",
    options: ["were", "was", "are"],
    correctAnswer: "were"
  }
];

const localStorageKey_Answers = 'quiz_bing_6_3_answers';
const localStorageKey_Score = 'quiz_bing_6_3_score';

export default function MateriBing6Bab3Page() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              ...
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 3"
                  frameBorder="0"
