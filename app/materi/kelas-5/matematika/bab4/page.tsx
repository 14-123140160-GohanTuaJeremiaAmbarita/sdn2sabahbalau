...
// --- DATA KUIS BAB 4 MTK KELAS 5 ---
const quizQuestions = [
  {
    question: "1. Dua bangun datar dikatakan kongruen jika memiliki bentuk dan ... yang sama.",
    options: ["Ukuran", "Warna", "Berat"],
    correctAnswer: "Ukuran"
  },
  {
    question: "2. Total sudut dalam segitiga adalah...",
    options: ["90 derajat", "180 derajat", "360 derajat"],
    correctAnswer: "180 derajat"
  },
  {
    question: "3. Sudut siku-siku memiliki besar ...",
    options: ["Kurang dari 90 derajat", "Tepat 90 derajat", "Lebih dari 90 derajat"],
    correctAnswer: "Tepat 90 derajat"
  },
  {
    question: "4. Jika dua bangun kongruen, maka sisi-sisi yang bersesuaian memiliki panjang yang...",
    options: ["Berbeda", "Setengahnya", "Sama"],
    correctAnswer: "Sama"
  },
  {
    question: "5. Sudut tumpul memiliki besar...",
    options: ["Kurang dari 90 derajat", "Antara 90 dan 180 derajat", "Lebih dari 180 derajat"],
    correctAnswer: "Antara 90 dan 180 derajat"
  },
  {
    question: "6. Jika sebuah segitiga memiliki dua sudut 40° dan 60°, sudut ketiganya adalah...",
    options: ["80°", "100°", "40°"],
    correctAnswer: "80°"
  },
  {
    question: "7. Pasangan bangun datar berikut yang PASTI kongruen adalah...",
    options: ["Dua persegi dengan panjang sisi berbeda", "Dua lingkaran dengan jari-jari sama", "Dua persegi panjang"],
    correctAnswer: "Dua lingkaran dengan jari-jari sama"
  },
  {
    question: "8. Sudut lurus memiliki besar...",
    options: ["180 derajat", "360 derajat", "90 derajat"],
    correctAnswer: "180 derajat"
  },
  {
    question: "9. Sudut yang besarnya 45° disebut sudut...",
    options: ["Siku-siku", "Tumpul", "Lancip"],
    correctAnswer: "Lancip"
  },
  {
    question: "10. Dua bangun yang sebangun belum tentu kongruen. (Benar/Salah)",
    options: ["Benar", "Salah"],
    correctAnswer: "Benar"
  }
];

const localStorageKey_Answers = 'quiz_mtk_5_4_answers';
const localStorageKey_Score = 'quiz_mtk_5_4_score';

export default function MateriMtk5Bab4Page() {
      ...
      <main className="py-10 md:py-16 flex-grow">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-700 text-center mb-10 md:mb-12">
            Materi Bab 4: Kekongruenan dan Sudut Bangun Datar
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 4"
                  frameBorder="0"
