...
// --- DATA KUIS BAB 8 MTK KELAS 5---
const quizQuestions = [
  {
    question: "1. Pecahan 1/2 senilai dengan...",
    options: ["2/4", "1/3", "2/3"],
    correctAnswer: "2/4"
  },
  {
    question: "2. Hasil dari 1/4 + 2/4 adalah...",
    options: ["3/8", "1/4", "3/4"],
    correctAnswer: "3/4"
  },
  {
    question: "3. Hasil dari 3/5 - 1/5 adalah...",
    options: ["2/5", "2/0", "4/5"],
    correctAnswer: "2/5"
  },
  {
    question: "4. Untuk menjumlahkan 1/2 + 1/3, kita harus menyamakan penyebutnya menjadi...",
    options: ["2", "3", "6"],
    correctAnswer: "6"
  },
  {
    question: "5. Hasil dari 1/2 + 1/3 adalah...",
    options: ["2/5", "5/6", "1/6"],
    correctAnswer: "5/6"
  },
  {
    question: "6. Bentuk pecahan sederhana dari 4/8 adalah...",
    options: ["1/2", "2/4", "8/4"],
    correctAnswer: "1/2"
  },
  {
    question: "7. Hasil dari 2/3 x 1/2 adalah...",
    options: ["3/5", "1/3", "2/6"],
    correctAnswer: "1/3" // (2/6 disederhanakan)
  },
  {
    question: "8. Hasil dari 1/2 ÷ 1/4 adalah...",
    options: ["2", "1/8", "1/2"],
    correctAnswer: "2"
  },
  {
    question: "9. 0.5 jika diubah menjadi pecahan biasa adalah...",
    options: ["1/5", "5/10 (atau 1/2)", "5/100"],
    correctAnswer: "5/10 (atau 1/2)"
  },
  {
    question: "10. Manakah pecahan yang nilainya paling besar?",
    options: ["1/2", "1/3", "1/4"],
    correctAnswer: "1/2"
  }
];

// Kunci unik untuk localStorage (Diubah untuk MTK Bab 8)
const localStorageKey_Answers = 'quiz_mtk_5_8_answers';
const localStorageKey_Score = 'quiz_mtk_5_8_score';

export default function MateriMtk5Bab8Page() {
