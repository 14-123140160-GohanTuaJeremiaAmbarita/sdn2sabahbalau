...
const quizQuestions = [
  {
    question: "1. 'What a nice shirt!' Kalimat tersebut adalah ungkapan...",
    options: ["Meminta (Asking)", "Memuji (Complimenting)", "Menolak (Refusing)"],
    correctAnswer: "Memuji (Complimenting)"
  },
  {
    question: "2. 'T-shirt' dalam bahasa Indonesia artinya...",
    options: ["Kemeja", "Kaos", "Rok"],
    correctAnswer: "Kaos"
  },
  {
    question: "3. 'Jacket' dalam bahasa Indonesia artinya...",
    options: ["Jaket", "Jas", "Dasi"],
    correctAnswer: "Jaket"
  },
  {
    question: "4. A: 'You look great in that dress!' B: '...'",
    options: ["I don't think so", "Thank you", "It's ugly"],
    correctAnswer: "Thank you"
  },
  {
    question: "5. 'Shoes' adalah...",
    options: ["Sepatu", "Kaus kaki", "Celana"],
    correctAnswer: "Sepatu"
  },
  {
    question: "6. 'What a beautiful...' (Sebuah gaun yang cantik)",
    options: ["Skirt", "Hat", "Dress"],
    correctAnswer: "Dress"
  },
  {
    question: "7. 'Trousers' atau 'Pants' artinya...",
    options: ["Celana panjang", "Celana pendek", "Piyama"],
    correctAnswer: "Celana panjang"
  },
  {
    question: "8. 'Red', 'Blue', and 'Green' are names of...",
    options: ["Clothes", "Colors", "Foods"],
    correctAnswer: "Colors"
  },
  {
    question: "9. We wear a ... on our head.",
    options: ["Hat", "Socks", "Shoes"],
    correctAnswer: "Hat"
  },
  {
    question: "10. 'Skirt' dalam bahasa Indonesia artinya...",
    options: ["Rok", "Gaun", "Topi"],
    correctAnswer: "Rok"
  }
];

const localStorageKey_Answers = 'quiz_bing_5_5_answers';
const localStorageKey_Score = 'quiz_bing_5_5_score';

export default function MateriBing5Bab5Page() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 5"
                  frameBorder="0"
