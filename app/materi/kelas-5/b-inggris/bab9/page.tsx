...
const quizQuestions = [
  {
    question: "1. A giraffe is the ... animal on Earth.",
    options: ["Tall", "Taller", "Tallest"],
    correctAnswer: "Tallest"
  },
  {
    question: "2. 'Tallest' adalah bentuk 'superlative' dari...",
    options: ["Tall", "Taller", "Talls"],
    correctAnswer: "Tall"
  },
  {
    question: "3. A cheetah is the ... land animal.",
    options: ["Fast", "Faster", "Fastest"],
    correctAnswer: "Fastest"
  },
  {
    question: "4. Mount Everest is the ... mountain in the world.",
  ...
  {
    question: "6. What is the superlative form of 'beautiful'?",
    options: ["Beautifuler", "More beautiful", "Most beautiful"],
    correctAnswer: "Most beautiful"
  },
  {
    question: "7. 'The Giraffe is the tallest.' 'Tallest' means...",
    options: ["Tinggi", "Lebih tinggi", "Paling tinggi"],
    correctAnswer: "Paling tinggi"
  },
  {
    question: "8. 'Big' -> 'Bigger' -> '...'",
    options: ["Bigly", "Biggest", "Most big"],
    correctAnswer: "Biggest"
  },
  {
    question: "9. The opposite of 'fastest' (tercepat) is ...",
    options: ["Slowest (terlambat)", "Strongest (terkuat)", "Smallest (terkecil)"],
    correctAnswer: "Slowest (terlambat)"
  },
  {
    question: "10. This is the ... book I have ever read. (interesting)",
    options: ["Interestingest", "More interesting", "Most interesting"],
    correctAnswer: "Most interesting"
  }
];

const localStorageKey_Answers = 'quiz_bing_5_9_answers';
const localStorageKey_Score = 'quiz_bing_5_9_score';

export default function MateriBing5Bab9Page() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 9"
                  frameBorder="0"
