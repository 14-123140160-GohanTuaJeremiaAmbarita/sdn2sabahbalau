...
const quizQuestions = [
  {
    question: "1. We use our ... to listen to music.",
    options: ["Eyes", "Ears", "Nose"],
    correctAnswer: "Ears"
  },
  {
    question: "2. We use our ... to see a rainbow.",
    options: ["Eyes", "Hands", "Tongue"],
    correctAnswer: "Eyes"
  },
  {
    question: "3. We use our ... to smell a flower.",
    options: ["Ears", "Mouth", "Nose"],
    correctAnswer: "Nose"
  },
  {
    question: "4. We use our ... to taste delicious food.",
    options: ["Tongue", "Nose", "Fingers"],
    correctAnswer: "Tongue"
  },
  {
    question: "5. We use our ... to touch a soft blanket.",
    options: ["Eyes", "Ears", "Hands"],
    correctAnswer: "Hands"
  },
  {
    question: "6. 'She listens to music.' 'Listens' means...",
    options: ["Melihat", "Mendengar", "Mencium"],
    correctAnswer: "Mendengar"
  },
  {
    question: "7. 'The cat feels soft.' We know this using our sense of...",
    options: ["Smell", "Hearing", "Touch"],
    correctAnswer: "Touch"
  },
  {
    question: "8. 'The lemon tastes sour.' We know this using our sense of...",
    options: ["Taste", "Sight", "Touch"],
    correctAnswer: "Taste"
  },
  {
    question: "9. 'I see a bird flying.' 'See' means...",
    options: ["Melihat", "Merasa", "Berbicara"],
    correctAnswer: "Melihat"
  },
  {
    question: "10. Which is NOT one of the five senses?",
    options: ["Sight", "Hearing", "Running"],
    correctAnswer: "Running"
  }
];

const localStorageKey_Answers = 'quiz_bing_5_6_answers';
const localStorageKey_Score = 'quiz_bing_5_6_score';

export default function MateriBing5Bab6Page() {
      ...
      <main className="py-10 md:py-16 flex-grow">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-700 text-center mb-10 md:mb-12">
            She Listens to Music with Her Ears
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video w-full mb-10 rounded-lg shadow-xl overflow-hidden border border-gray-200">
              {loadingVideo ? (
                ...
                <iframe
                  src={videoUrl}
                  title="Video Pembelajaran Bab 6"
                  frameBorder="0"
